...
def calculate_demographic_data(print_data=True):
    ...
    highest_earning_country_percentage = round((len(df[(df.salary == ">50K") & (df["native-country"] == highest_earning_country)]) * 100) / len(df[df["native-country"] == highest_earning_country]), 1)
